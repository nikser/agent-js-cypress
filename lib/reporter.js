...
class Reporter {
  ...
  suiteStart(suite) {
    ...
    this.suitesStackTempInfo.push({ tempId, start_time: suite.start_time });
  }
  ...
  testStart(test) {
    ...
    this.currentTestTempInfo = { tempId, start_time: startTestObj.start_time };
  }
  ...
  hookStart(hook) {
    ...
    switch (hookStartObject.type) {
      case entityType.BEFORE_SUITE:
        hookStartObject.start_time = this.getCurrentSuiteInfo().start_time - 1;
        break;
      case entityType.BEFORE_METHOD:
        hookStartObject.start_time = this.currentTestTempInfo
          ? this.currentTestTempInfo.start_time - 1
          : hookStartObject.start_time;
        break;
      default:
        break;
    }
